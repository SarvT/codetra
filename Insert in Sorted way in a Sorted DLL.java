...
class Solution {
    public Node sortedInsert(Node head, int x) {
        ...
        while(tmp != null){
            if(tmp.data>x && prv!= null && prv.data<=x){
                Node newNode = new Node(x);
                prv.next = newNode;
                newNode.prev = tmp.prev;
                newNode.next = tmp;
                tmp.prev = newNode;
            } else if(prv==null && tmp.data>x){
                ...
                head = newNode;
                break;
            } else if(tmp.next == null && tmp.data<=x){
                Node newNode = new Node(x);
                newNode.prev = tmp;
                newNode.next = null;
                tmp.next = newNode;
...
class Solution {
    public Node sortedInsert(Node head, int x) {
        ...
        Node current = head;
        while (current.next != null && current.next.data < x) current = current.next;
